...
{% hint style="info" %}
Si vous modifiez le fichier, copiez-le dans le dossier user\inputmapping de votre installation RetroBat, sinon vous risquez de le perdre lors d'une mise à jour de RetroBat
{% endhint %}
