...
<table data-header-hidden><thead><tr><th width="224"></th><th></th></tr></thead><tbody><tr><td><strong>Émulateur</strong></td><td><ul><li>dolphin-triforce</li><li>dolphin</li><li>libretro: dolphin</li><li>teknoparrot</li></ul></td></tr><tr><td><strong>Dossier des jeux</strong></td><td><span data-gb-custom-inline data-tag="emoji" data-code="1f4c2">📂</span> roms \ <span data-gb-custom-inline data-tag="emoji" data-code="1f4c2">📂</span> triforce</td></tr><tr><td><strong>Extensions</strong></td><td>.iso .zip .cue .7z</td></tr></tbody></table>

Dolphin-Triforce est le build Crediar de dolphin triforce, qui est également utilisé par Teknoparrot.

La branche principale de Dolphin (ainsi que le core libretro) ont integré le support de l'émulation Triforce depuis février 2026.
...
| Fichier BIOS | Dossier                                     | Remarque                 |
| ------------ | ------------------------------------------- | ------------------------ |
| segaboot.gcm | `\emulators\dolphin-emu\User\Triforce`      | Pour l'émulateur Dolphin |
| segaboot.gcm | `\saves\triforce\dolphin-emu\User\Triforce` | Pour Libretro-dolphin    |

## Contrôles

Les contrôles sont similaires à ceux utilisés par Dolphin pour la Gamecube.

Il est possible de paramétrer les contrôles directement dans l'émulateur dolphin-triforce, en utilisant la même procédure que pour Gamecube.
...
Le Menu Service est accessible depuis la manette en utilisant les boutons R3 et L3, ou depuis le clavier en utilisant les touches 0 et 9.
