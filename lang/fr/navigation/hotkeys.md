...
<table><thead><tr><th width="269">Hotkeys (clavier)</th><th>Action</th></tr></thead><tbody><tr><td>Hotkey + <img src="../.gitbook/assets/image (7).png" alt="">  (F6)</td><td>PAUSE</td></tr><tr><td>Hotkey + <img src="../.gitbook/assets/image (20).png" alt="">  (TAB)</td><td>Fullscreen</td></tr><tr><td>Hotkey + <img src="../.gitbook/assets/image (35).png" alt="">   (F2)</td><td>Charger Save State</td></tr><tr><td>Hotkey + <img src="../.gitbook/assets/image (33).png" alt="">   (F1)</td><td>Sauver Save State</td></tr><tr><td>Hotkey + START  (F12)</td><td>Quitter JGenesis</td></tr><tr><td>Hotkey + D-PAD UP  (F4)</td><td>Step frame</td></tr><tr><td>Hotkey + D-PAD DOWN  (F3)</td><td>Soft reset</td></tr><tr><td>Hotkey + D-PAD LEFT  (F8)</td><td>Rembobiner</td></tr><tr><td>Hotkey + D-PAD RIGHT  (F9)</td><td>Avance rapide</td></tr></tbody></table>
