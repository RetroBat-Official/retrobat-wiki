...
Use LEFT and RIGHT to change categories and UP and DOWN to navigate the list and choose the content to install, press ![](<../.gitbook/assets/image (30).png>) to install
...
Navigate to the theme you want to install and press ![](<../.gitbook/assets/image (30).png>) to install
